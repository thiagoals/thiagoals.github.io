...
@Component({
  selector: 'app-adicionar-aplicacao',
  templateUrl: './adicionar-aplicacao.component.html',
  styleUrls: ['./adicionar-aplicacao.component.css']
})
export class AdicionarAplicacaoComponent implements OnInit {
